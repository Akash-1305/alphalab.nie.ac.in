          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-blue-200 mb-6 leading-relaxed">
                Pioneering innovation through collaborative research and
                development. Empowering the next generation of makers and
                innovators.
              </p>
              ...
              <div className="flex space-x-4">
                {[
                  {
                    icon: Linkedin,
                    href: "https://www.linkedin.com/company/alpha-innovation-and-tinkerers-lab/",
                    label: "LinkedIn",
                  },
                  {
                    icon: Instagram,
                    href: "https://www.instagram.com/aitl_nie_mysuru/",
                    label: "Instagram",
                  },
                ].map((social, index) => (
                  <a
            ...
            <div>
              ...
              <p className="text-blue-200 mb-6 leading-relaxed">
                Subscribe to get the latest updates on innovations, events, and
                opportunities at ALPHA Lab.
              </p>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6">
              <p className="text-blue-200 text-center">
                &copy; {new Date().getFullYear()} ALPHA Lab, NIE Mysore. All
                rights reserved.
              </p>
            ...
            <div className="flex items-center space-x-6">
              <p className="text-blue-200 flex items-center text-sm">
                Made with <Heart className="h-4 w-4 text-red-400 mx-1" /> in
                Mysore, India
              </p>
              <button
                onClick={scrollToTop}
